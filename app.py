...
st.set_page_config(layout="wide",page_title="Carbon Manager - A Unique Solution to Global Warming using ML", page_icon="./media/favicon.ico")
...
tab_result.markdown(f"""You owe nature <b>{tree_count}</b> tree{'s' if tree_count > 1 else ''} this month. <br> {f"<a href='https://www.tatapower.com/green-community/tree-mittra' id = 'button-17' class='button-17' role='button'> 🌳 Lets Do It Myself 🌳</a>" if tree_count > 0 else ""}""",  unsafe_allow_html=True)
