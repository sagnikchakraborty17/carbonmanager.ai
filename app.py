...
tab_result.markdown(f"""You owe nature <b>{tree_count}</b> tree{'s' if tree_count > 1 else ''} this month. <br> {f"<a href='https://www.tatapower.com/green-community/tree-mittra' id = 'button-17' class='button-17' role='button'> 🌳 Let's Do it Myself Boys! 🌳</a><br><br><b>OR</b><br><br><a href='https://sankalptaru.org' id = 'button-17' class='button-17' role='button'> 🌳 Let NGOs Plant For Me! 🌳</a><br><br><a href='https://tinyurl.com/CMReportProofSubmission' id = 'button-17' class='button-17' role='button'>Send My Report & Offset Proof</a><br><br><a href='' id = 'button-17' class='button-17' role='button'>Report Correction Coefficient</a><br><br><a href='https://appdevelopersagnik.wixsite.com/carbon-manager-forum' id = 'button-17' class='button-17' role='button'>Go to Carbon Mananger-Forum</a><br>" if tree_count > 0 else ""}""",  unsafe_allow_html=True)
