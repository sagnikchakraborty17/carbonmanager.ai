...
tab_result.markdown(f"""You owe nature <b>{tree_count}</b> tree{'s' if tree_count > 1 else ''} this month. <br> {f"<a href='https://www.tatapower.com/green-community/tree-mittra' id = 'button-17' class='button-17' role='button'> 🌳 Let's Do it Myself ! 🌳</a><br><br><b>OR</b><br><br><a href='https://sankalptaru.org' id = 'button-17' class='button-17' role='button'> 🌳 Let NGOs Plant For Me! 🌳</a><br><br><a href='https://tinyurl.com/CMReportProofSubmission' id = 'button-17' class='button-17' role='button'>Send My Report & Offset Proof</a><br><br><a href='https://tinyurl.com/CMCorrectionFactor' id = 'button-17' class='button-17' role='button'>Report Correction Factor</a><br><br><a href='https://appdevelopersagnik.wixsite.com/carbon-manager-forum' id = 'button-17' class='button-17' role='button'>Go to Carbon Mananger-Forum</a><br><br><a href='javascript: var chatDiv = document.createElement(`div`); chatDiv.id = `botpressChat`; document.body.appendChild(chatDiv); var script1 = document.createElement(`script`); script1.src = `https://cdn.botpress.cloud/webchat/v1/inject.js`; document.body.appendChild(script1); var script2 = document.createElement(`script`); script2.src = `https://mediafiles.botpress.cloud/c80ccde7-2db0-4ca9-99b0-14c91448ee4e/webchat/config.js`; script2.defer = true; document.body.appendChild(script2);' target='_self' id = 'button-17' class='button-17' role='button'>Ask AI Chatbot</a>" if tree_count > 0 else ""}""",  unsafe_allow_html=True)
